...
FormField.create!(id: 17, data: "yesterday")

# Backup fields
FormField.create!(id: 18, data: "<h2>AFX TEAM SWITCH/DROP FORM</h2>")
FormField.create!(id: 19, data: "<p><h1><center>Welcome to AFX Dance, Fall 2077!</center></h1></p>")
FormField.create!(id: 20, data: "<p>If you are viewing this form, it means that you are <b>UNABLE</b> to participate in the PROJECT or TRAINING team that you are <b><u>CURRENTLY ON</b></u> on due to a <b>time conflict</b>. Through this form, you will also be able to DROP from AFX Project/Training this semester.
<p><b>[DEADLINE FOR SUBMISSION: SATURDAY, 9/21/2019 @ 11:59 PM.] </b>
<br><b><u>NO EXCEPTIONS!</u></b>
...
<br>")
FormField.create!(id: 21, data: "<p><b>ALL FOLLOWING INFORMATION MUST EXACTLY MATCH THE INFORMATION SUBMITTED ON AUDITION DAY:
</b></p>
  <br>")
FormField.create!(id: 22, data: "<p><h3><center><b><u>PROJECT TEAM SWITCH</u></b></center></h3>")
FormField.create!(id: 23, data: "  <b><i>[You may ONLY answer this if you are currently on a Project Team.]</i></b>
  <p><b><u>TO SWITCH INTO A DIFFERENT AFX PROJECT TEAM:</u></b>
    <br>
  If you would like to <b>switch into a different Project Team</b>, please select ALL other Project Teams’ times that you can attend:")
FormField.create!(id: 24, data: "<p><b><u>TO SWITCH INTO AN AFX TRAINING TEAM FROM YOUR AFX PROJECT TEAM:</u></b>
    <br>
    If you would like to <b>switch into a Training Team</b>, please refer to the “Training Team Switch” portion of this form.
...
FormField.create!(id: 25, data: "<p><h3><center><b><u>TRAINING TEAM SWITCH</u></b></center></h3>")
FormField.create!(id: 26, data: "<b><i>[This portion is for all members currently placed on a Training Team OR on a Project Team who would like to switch into a Training Team.]
</i></b>

<p><b><u>TO SWITCH AFX TRAINING TEAMS:</u></b>
    <br>
  If you would like to <b>join or switch into a different Training Team</b>, please select ALL Training Teams’ times (AT LEAST <b>TWO</b>) that you can attend:")
FormField.create!(id: 27, data: "<p><b>Failure to comply with any instructions will lead to your team switch request being dismissed.</b></p><br><br>")
FormField.create!(id: 28, data: "<p><h3><center><b><u>DROP FROM AFX PROJECT/TRAINING</u></b></center></h3>")
FormField.create!(id: 29, data: "<b><i>[ONLY ANSWER THIS QUESTION IF YOU HAVE CHOSEN TO DROP FROM AFX DANCE’S PROJECT AND TRAINING TEAMS THIS SEMESTER.]</i></b><br>")
FormField.create!(id: 30, data: "<p><br><b>Once you select this box, you may not re-join AFX this semester. Please consult with your directors to discuss your circumstances before making this decision. You may also email afxdanceviceexecutive@gmail.com for further questions!</b></p><br><br>")
FormField.create!(id: 31, data: "<p><b>What is your reason for switching into a different team or dropping from AFX? Please explain your time conflict and what prevents you from attending your current team’s practices.*  </b></p>")
FormField.create!(id: 32, data: "<p><b>We urge you to PLEASE double-check all of your contact information and answers as inputting incorrect information may lead to an unattended request, a rejected request, or a drop from AFX. Have you reviewed all of your responses carefully?*</b></p>")
FormField.create!(id: 33, data: "<p>Again, if you have any further questions, please email afxdanceviceexecutive@gmail.com and we will try to respond within 24 hours. You will receive an email with the results once your team switch or drop request has been successfully processed. Please check your email’s spam folder in case the email is delivered there. All notices and results are delivered ONLY from afxdanceviceexecutive@gmail.com. Thank you for your patience!</p>
